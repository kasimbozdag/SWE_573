...
import { createQuestion } from "../redux/actions/global";
...
class CreateQuestion extends Component {
  ...
  _doCreate = () => {
    ...
    this.props
      .createQuestion(file, title, text, id)
      .then(() => <Redirect to="/myLcreateQuestions" />);
  };
}
...
function bindAction(dispatch) {
  return {
    createQuestion: (file, title, text, id) =>
      dispatch(createQuestion({ file, title, text, id }))
  };
}
