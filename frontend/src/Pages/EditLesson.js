...
import { editLesson, getLesson } from "../redux/actions/global";
...
class EditLesson extends Component {
  ...
  componentDidMount() {
    ...
    if (lesson !== null && lesson.id == id) {
      this.setState({
        ["title"]: lesson.title,
        ["text"]: lesson.description.text,
        ["file"]: lesson.description.file
      });
    }
  }
  handleChange = event => {
  ...
  _doUpdate = () => {
    ...
    let id = this.props.match.params.id;
    this.props.dispatch(editLesson({ title, text, id, file })).then();
  };
}
