...
import { editContent, getContent } from "../redux/actions/global";
...
class EditContent extends Component {
  ...
  componentDidMount() {
    ...
    this.props.dispatch(getContent(this.props.match.params.id)).then(() => {
      let { content } = this.props.global;
      let id = this.props.match.params.id;
      console.log(content, id);
  ...
  _doUpdate = () => {
    ...
    let id = this.props.match.params.id;
    this.props.dispatch(editContent({ title, text, id, file })).then();
  };
}
